...
module.exports=data = {
    ...
    "requirements": [
      {"cloud services": ["nightscout"]},
      {"cgm": ["dexcom g4", "dexcom g4 with share", "g5", "freestyle libre"]},
      {"smartwatches": ["pebble classic", "pebble steel", "pebble time", "pebble time steel"]},
      {"phone": ["android", "iOS"]}
    ],
    "project categories": [
      "cloud services",
...
var things_we_have = Immutable.Set(["pebble time", "nightscout"]);
var everything = [];
var none = [];
var some = [];
...
try {
	for (var _iterator = data.projects[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
		...
		try {
			for (var _iterator2 = project.configurations[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
				var dependencies = _step2.value;

				var dep = Immutable.Set(dependencies);

				var intersection = dep.intersect(things_we_have);
...
console.log("some");
console.log(some);
},{"../data/example_data.json":1,"immutable":"immutable"}],"immutable":[function(require,module,exports){
/**
